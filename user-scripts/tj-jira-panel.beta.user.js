...
// @grant        none
// @updateURL    https://cdn.jsdelivr.net/npm/@ens-davids/tj-jira-panel@beta/user-scripts/tj-jira-panel.beta.user.js
// @downloadURL  https://cdn.jsdelivr.net/npm/@ens-davids/tj-jira-panel@beta/user-scripts/tj-jira-panel.beta.user.js
// ==/UserScript==
...
const insertWebElementScript = () => {
  ...
  const isValidVersion = version?.includes('beta');
  const url = `https://cdn.jsdelivr.net/npm/@ens-davids/tj-jira-panel@${isValidVersion ? version : 'beta'}/dist/tj-jira-panel/tj-jira-panel.esm.js`;
  script.src = url;
  script.type = 'module';
